...
Scale_area = Scale_current * FaradayEff / CurrentperArea_electrode # m^2
...
ScaleFlowRate_gasCath = ScaleMassRate_inCO2 * (1 - TotalPassCO2Eff) / Density_CO2 + ScaleMassRate_byproductCath / Density_byproductCath
